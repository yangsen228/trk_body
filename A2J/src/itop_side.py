...
keypointsfileTest = '../data/itop_side/itop_{}_keypoints3D_{}_full.mat'.format(view, mode)
bndbox_test = scio.loadmat('../data/itop_side/itop_{}_bndbox_{}_full.mat'.format(view, mode) )['FRbndbox_test']   
center_test = scio.loadmat('../data/itop_side/itop_{}_center_{}_full.mat'.format(view, mode))['centre_pixel']
Img_mean = np.load('../data/itop_side/itop_side_mean.npy')[3]
Img_std = np.load('../data/itop_side/itop_side_std.npy')[3]
model_dir = '../model/ITOP_side.pth'
...
def main():   
    ...
    Accuracy_test, preds_3d = evaluation10CMRule(result,keypointsWorldtest,bndbox_test, center_test)
    print('Accuracy:', Accuracy_test)
    # np.save(os.path.join(save_dir, 'ITOP_{}_{}_labels_a2j.npy'.format(view, mode)), preds_3d)
