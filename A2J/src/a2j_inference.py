...
save_dir = '/home/dl-box/yang/3d_HPE_depth/RTW/rtw_py/data/processed/ITOP'
view = 'side'
mode = 'test'
...
testingImageDir = '/home/dl-box/yang/datasets/ITOP/A2J/{}_{}_full/'.format(view, mode)
keypointsfileTest = '/home/dl-box/yang/3d_HPE_depth/A2J/data/itop_side/itop_{}_keypoints3D_{}_full.mat'.format(view, mode)
bndbox_test = scio.loadmat('/home/dl-box/yang/3d_HPE_depth/A2J/data/itop_side/itop_{}_bndbox_{}_full.mat'.format(view, mode) )['FRbndbox_test']   
center_test = scio.loadmat('/home/dl-box/yang/3d_HPE_depth/A2J/data/itop_side/itop_{}_center_{}_full.mat'.format(view, mode))['centre_pixel']
Img_mean = np.load('/home/dl-box/yang/3d_HPE_depth/A2J/data/itop_side/itop_side_mean.npy')[3]
Img_std = np.load('/home/dl-box/yang/3d_HPE_depth/A2J/data/itop_side/itop_side_std.npy')[3]
model_dir = '/home/dl-box/yang/3d_HPE_depth/A2J/model/ITOP_side.pth'
...
def dataPreprocess(index, img, keypointsPixel, keypointsWorld, bndbox, center, depth_thres=0.4):
...
def a2j_detection(index):   
    ...
    with torch.no_grad():
        img, label = test_image_datasets.__getitem__(index)
        img, label = img.unsqueeze(0).cuda(), label.unsqueeze(0).cuda()
        heads = net(img)          
        pred_keypoints = post_precess(heads,voting=False)
        output = torch.cat([output,pred_keypoints.data.cpu()], 0)
        
    result = output.cpu().data.numpy()
    preds_2d = getPred2D(result, bndbox_test[index:index+1])
